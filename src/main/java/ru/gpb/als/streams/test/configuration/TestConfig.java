...
public class TestConfig {
  ...
  public Properties streamProperties() {
    ...
    props.put(StreamsConfig.DEFAULT_KEY_SERDE_CLASS_CONFIG, TestKafkaAvroSerde.class);
    props.put(StreamsConfig.DEFAULT_VALUE_SERDE_CLASS_CONFIG, TestKafkaAvroSerde.class);
